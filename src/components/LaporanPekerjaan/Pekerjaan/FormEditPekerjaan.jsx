// src/components/FormEditPekerjaan.jsx
import { useState, useEffect } from "react";

export default function FormEditPekerjaan({ initialData, onSubmit, onCancel }) {
  ...
  // Mapping dari initialData (bisa dari tabel: No, HariTanggal, dst)
  useEffect(() => {
    if (initialData) {
      setFormData({
        idPekerjaan:
          initialData.idPekerjaan ||
          initialData.id ||
          `P-${initialData.No ?? "000001"}`,
        hariTanggal:
          initialData.hariTanggal || initialData.HariTanggal || "",
        jenisPekerjaan:
          initialData.jenisPekerjaan || initialData.JenisPekerjaan || "",
        bagian: initialData.bagian || initialData.Bagian || "",
        petugas: initialData.petugas || initialData.Petugas || "",
        deskripsi: initialData.deskripsi || initialData.Deskripsi || "",
